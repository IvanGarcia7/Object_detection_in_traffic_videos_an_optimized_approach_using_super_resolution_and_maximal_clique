...
def make_inference_SRSRold(detect_fn,category_index,image_path,image_name,image_save,selected_classes,min_score,MODEL_SR_DIR):
  ...
  img__READ = cv2.imread(image_path)
  height, width, channels = img__READ.shape  
  createSR2(image_path,MODEL_SR_DIR+'/FSRCNN_x2.pb',MODEL_SR_DIR+'/SR_Frame.png')
  im = Image.open(MODEL_SR_DIR+'/SR_Frame.png')
  ...
  number_files_ours = number_files_ours_aux
